...
l=[]
for i in range(n):
    t=list(map(int,input().split()))+[i+1]+[0]
    for j in range(3):
        t[4]=t[j]+t[4]
    l.append(t)
i=0
while i<n-1:
    ...
    for j in range(n-1,k,-1):
        if l[j][4]>l[j-1][4] or l[j][4]==l[j-1][4] and l[j][0]>l[j-1][0] or l[j][4]==l[j-1][4] and l[j][0]==l[j-1][0] and l[j][3]<l[j-1][3]:
            l[j],l[j-1]=l[j-1],l[j]
            i=j
for i in range(5):
    print(str(l[i][3])+' '+str(l[i][4]))